...
# Salt Lake City
craig_page_SLC = "https://saltlakecity.craigslist.org/search/sss?query={}&sort=rel".format(
    clean_item(Item)
)

# Logan
craig_page_Logan = "https://logan.craigslist.org/search/sss?query={}&sort=rel".format(
    clean_item(Item)
)

# Ogden
craig_page_Ogden = "https://ogden.craigslist.org/search/sss?query={}&sort=rel".format(
    clean_item(Item)
)

# Provo
craig_page_Provo = "https://provo.craigslist.org/search/sss?query={}&sort=rel".format(
    clean_item(Item)
)

# St George
craig_page_StGeo = "https://stgeorge.craigslist.org/search/sss?query={}&sort=rel".format(
    clean_item(Item)
)
...
for i in content_SLC.find_all("li", {"class": "result-row"}):
    ...
    # 'Item' Name search/pull
    print(i.find("a", {"class": "result-title hdrlnk"}).text)
    # 'Item' Price search/pull
    print(i.find("span").text)
    # 'Item' Image search/pull
    print(i.find("a", {"class": "result-image gallery"}))
